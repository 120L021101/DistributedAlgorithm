...
# CMD python -u -m cs4545.system.run_bracha -MD1 -MD2 -MD3 -MD4 -MD5 $PID $IS_BROADCASTER $BROADCAST_NUM $IS_BYZANTINE $BYZANTINE_NUM $NODES_NUM $BYZANTINE_BEHAVIOUR $IS_BRB_BYZANTINE $BRB_BYZANTINE_NUM $TOPOLOGY $ALGORITHM -location=$LOCATION -docker
CMD python -u -m cs4545.system.run_causal -MD1 -MD2 -MD3 -MD4 -MD5 $PID $IS_BROADCASTER $BROADCAST_NUM $IS_BYZANTINE $BYZANTINE_NUM $NODES_NUM $BYZANTINE_BEHAVIOUR $IS_BRB_BYZANTINE $BRB_BYZANTINE_NUM $TOPOLOGY $ALGORITHM -location=$LOCATION -docker