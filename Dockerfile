...
CMD python -u -m cs4545.system.run_dolev $PID $IS_BROADCASTER $BROADCAST_NUM $IS_BYZANTINE $BYZANTINE_NUM $BYZANTINE_BEHAVIOUR $TOPOLOGY $ALGORITHM -location=$LOCATION -docker
